    ...
    return (
        <footer class="marketing-site-footer" id="footer">
            ...
            <div class="medium-4 columns">
                ...
                <p>These quizes (as well as peer-reviewed mental-health scales) should not be viewed as or replace the opinion of a professional, and does not act as a diagnosis.</p>
